...
public record Mutation(@NotNull Map<String, Object> values, @NotNull Map<String, Operation> operations) {
    public enum Kind { INCREMENT, APPEND, REMOVE }
    ...
    public static final class Builder {
        ...
        public <T> @NotNull Builder append(final @NotNull FieldRef<? extends java.util.Collection<T>> field, final @Nullable T value) { operations.put(field.name(), new Operation(Kind.APPEND, value)); return this; }
